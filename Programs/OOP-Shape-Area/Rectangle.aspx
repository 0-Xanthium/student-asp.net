...
<body>
    ...
    <div align="center">
        <asp:TextBox ID="txtLength" runat="server" placeholder = "Enter the length of rectangle "></asp:TextBox><br /><br />
        <asp:TextBox ID="txtBreadth" runat="server" placeholder = "Enter the breadth of rectangle "></asp:TextBox><br /><br />
